...
summ_f() - возвращает сумму цифр введённого числа.  
mult_f() - возвращает произведение цифр введённого числа.  
average_f() - возвращает среднее арифметическое суммы цифр введённого числа.  
...
area_of_a_triangle() - находит площадь треугольника по введённым сторонам.
sqrt() - возвращает квадратный корень введённого числа.  
...
type_of_the_triangle() - возвращает значения от 1 до 5, в зависимости от типа треугольника.  
pow() - возводит введённое число в необходимую степень.  


**К отчёту приложить файлы проектов программ.**

[Задание 1](lab4.1.cpp). [Задание 2](lab4.2.cpp). [Задание 3](lab4.3.cpp).   
...
{  
    ...
    while (!inp_stream.eof()) {                                 
        ...
        summ = summ_f(present_value);  
        mult = mult_f(present_value);  
        average = average_f((float)present_value);  
        printf("В числе %d сумма цифр = %d, произведение цифр = %d, среднее арифмметическое = %f\n", present_value, summ, mult, average);  
    }  
    inp_stream.close();                                          
}  
...
int calculation(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9, int a10, int a11, int a12) {  
	int res;  
	res = area_of_a_triangle(a1, a2, a3) + area_of_a_triangle(a4, a5, a3) + area_of_a_triangle(a7, a5, a6) + area_of_a_triangle(a7, a8, a9) + area_of_a_triangle(a9, a10, a11) + area_of_a_triangle(a1, a12, a11);  
	return res;  
}  
int data_file(FILE* f_input) {  
	int a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, res; 
	fscanf(f_input, "%d%d%d%d%d%d%d%d%d%d%d%d", &a1, &a2, &a3, &a4, &a5, &a6, &a7, &a8, &a9, &a10, &a11, &a12);  
	res = calculation(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12);  
	return res;  
}  
int out_screen(int res) {  
	cout << "Площадь многоугольника в мм = " << res;  
	return 1;  
}  
int main() {  
